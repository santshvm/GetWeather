...
* After starting the server, you should get a message - "Server is running on port 3000" and your app should be now running at [localhost:3000](http://localhost:3000/)
